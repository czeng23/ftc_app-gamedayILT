...
public abstract class Constants {
    ...
    */
    // RR Jewel color discriminators, designed to reject brown of the Pictographs, and allow
    // darker shades which might be seen in poorly lit Fields.
    public static final ColorHSV COLOR_RED_LOWER = new ColorHSV((int) (310.0 / 360.0 * 255.0),
                                                                 (int) (0.600 * 255.0), (int)
                                                                                          (0.50 * 255.0));
    public static final ColorHSV COLOR_RED_UPPER = new ColorHSV((int) (357.5 / 360.0 * 255.0),
                                                                 255, 255);
    public static final ColorHSV COLOR_BLUE_LOWER = new ColorHSV((int) (170.0 / 360.0 * 255.0),
                                                                  (int) (0.600 * 255.0), (int)
                                                                                          (0.300 * 255.0));
    public static final ColorHSV COLOR_BLUE_UPPER = new ColorHSV((int) (270.0 / 360.0 * 255.0), 255, 255);
