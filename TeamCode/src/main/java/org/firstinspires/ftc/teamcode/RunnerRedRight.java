 ...
 * Vincent Delgado v 0.5 1/12/18: just a copy of RunnerBlueLeft, with directions reversed
 */

@Autonomous(name = "Runner Red Right", group = "Game Day 3") // NOT TESTED
  //@Disabled
  public class RunnerRedRight extends LinearVisionOpMode {
  ...
  private static final double JEWEL_KNOCK_DISTANCE = 2.75; // inches;
	private double turn2Safety = Math.PI/2; // 90 deg ccw
  ...
  public void runOpMode() throws InterruptedException {
	  ...
	  robot.runtime.reset();
		...
		targetJewel = robot.decideTargetJewel("Red"); // TESTED, works.
    report = String.format("Jewel decision %.2f", robot.runtime.seconds());
	  ...
	  */
	  ...
	  // Pull paddle back so it won't hit our own Jewel. Allow time for that before the next turn.
		...
		sleep(1000);
		// Turn left toward Cryptobox and Safety Zone.
