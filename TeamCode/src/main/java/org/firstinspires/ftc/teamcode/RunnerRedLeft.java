...
/**
 * Autonomous OpMode for robot in Red Alliance, starting on left Balancing
 ...
 * This one works, probably beta quality for gameday3.
  *Vincent Delgado v 0.5 1/12/18: just a copy of RunnerBlueLeft
 */

@Autonomous(name = "Runner Red Left", group = "Game Day 3") // NOT TESTED
  //@Disabled
  public class RunnerRedLeft extends LinearVisionOpMode {
  private static final double D2SAFETY = 32.0; // not TESTED
  private static final double JEWEL_KNOCK_ANGLE = 0.30; // radians
  private static final double JEWEL_KNOCK_DISTANCE = 2.75; // inches;
	private double turn2Safety = 2*Math.PI/3; // About 120 degrees CW
