...
/**
 * Autonomous OpMode for robot in Red Alliance, starting on right Balancing
 * Stone.
 *
 ...
 *   Strafe to Safety Zone. It will be directly to the left, distance
 *   D2SAFETY. The
 ...
 *     Meet 1 code.
 *   v 0.4 gf 11/28/17 : partially adapted from blueleft, not just name only. Look down to see
 *     where gf adaptation ends.
 *   v 0.41 jmr 11/29/17, arrives at a correct strafing decision for knocking off the opponent Blue
 *     Jewel from the Platform.
 *   v 0.42 oc 11/30/17: Adapted blue left for red right case.
 */

@Autonomous(name="Red Right", group ="Gameday 1")
//@Disabled
public class RedRight extends LinearVisionOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //   robot.goSideways (-D2SAFETY - JEWEL_KNOCK); // gf adaptation ends here
        // }
